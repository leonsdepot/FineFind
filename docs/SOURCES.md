...
- [Dictionaries in JavaScript (How To Guide)](https://medium.com/@ryan_forrester_/dictionaries-in-javascript-how-to-guide-05457a0c581b)
- [JavaScript Maps](https://www.w3schools.com/js/js_maps.asp)
- [JavaScript Object Accessors](https://www.w3schools.com/js/js_object_accessors.asp)
- [Prozentrechnung](https://studyflix.de/mathematik/prozentrechnung-2974)
- [Using for..of loop on ES6 Map](https://stackoverflow.com/a/34390374)
- [for...of](https://developer.mozilla.org/de/docs/Web/JavaScript/Reference/Statements/for...of)
- [get](https://developer.mozilla.org/de/docs/Web/JavaScript/Reference/Functions/get)
- [set](https://developer.mozilla.org/de/docs/Web/JavaScript/Reference/Functions/set)